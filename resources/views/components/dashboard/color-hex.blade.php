<div class='color-picker-container'>
    <img class='color-picker' src="img/img_colormap.gif" usemap="#colormap" alt="colormap"><map id="colormap" name="colormap" onmouseout="mouseOutMap()">
	...
	<area style="cursor:pointer" shape="poly" coords="171,180,180,184,180,195,171,199,162,195,162,184" onclick="clickColor('#993333',-20,162)" onmouseover="mouseOverColor('#993333')" alt="#993333"></map>
<script>
var thistop = "-35";
var thisleft = "135";
</script>
	<div id="selectedhexagon" style="visibility: hidden; position: relative; width: 21px; height: 21px; background-image: url('img/img_selectedcolor.gif'); top: -80px; left: 126px;"></div>
    <div id="divpreview" style="visibility: hidden; background-color: rgb(255, 0, 0);color: white;">
    </div>
	<input id='color-hex' type='hidden' name='color-hex' value=''>
</div>